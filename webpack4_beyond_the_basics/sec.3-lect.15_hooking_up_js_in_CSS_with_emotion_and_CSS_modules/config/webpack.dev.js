    ...
    rules: [
      {
        ...
        use: [
          ...
          },
          {
            ...
            loader: "css-loader",
            //Adding some options for css-loader
            query: {
              //modules true gives the ability to import the css
              //into js files using import statements
              modules: true,
              //When importing css into react, styles of components can be hooked
              //by using : className={myImportedCSS.myCSSClass}
              //React creates a class that link the CSS class to the html element
              //This class has a hash name and can be configured using localIdentName
              //note that [name] refers to css filename and [local] to the class inside css file
